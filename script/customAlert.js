...
const customAlertClose = document.createElement("span");
customAlertClose.id = "customAlertClose";
customAlertClose.className = "custom-alert-close";
customAlertClose.innerHTML = "&times;";
...
customAlertOk.innerHTML = "OK";

// Append elements to the inner div
customAlertContent.appendChild(customAlertClose);
...
// Event listener to close the custom alert box when the close button is clicked
